...
public class Pusher {
     ...
     * 测试号的appId和secret
     */
    private static String appId = "wxb76f0f84733e1b4d";
    private static String secret = "a49b70794a4ce6d68b7a500aaea64122";
    //模版id
    private static String templateId = "kqVsJ1SilxWhcVjiqQYsNB1WKzt-T0Mg2sI46o1KbcA";
    ...
    public static void push(String openId){
        ...
        templateMessage.addData(new WxMpTemplateData("linZheng",JiNianRi.getLinZhen()+"","#FF6347"));
        String beizhu = "";
        ...
        String pig="永远爱你的猪！！！";
        String happy="今天也要乖乖的多喝水哈~~（*^▽^*）！";
        templateMessage.addData(new WxMpTemplateData("beizhu",beizhu,"#FF0000"));
        templateMessage.addData(new WxMpTemplateData("pig",pig,"#FF0000"));
        templateMessage.addData(new WxMpTemplateData("happy",happy,"#FF0000"));
